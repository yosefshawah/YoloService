...
def create_dummy_image_bytes():
    img = Image.open("beatles.jpeg")  # use your real image here
    img_bytes = BytesIO()
...
class TestPredictEndpoint(unittest.TestCase):
    ...
    def test_predict_with_real_image(self):
        ...
        response = self.client.post("/predict", files={"file": ("beatles.jpg", img_file, "image/jpeg")}, headers=get_auth_header())
